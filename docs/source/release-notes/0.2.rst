...
.. warning::
    ...
    We recommend not to use this version of Magnopy due to :issue:`79`, that can affect
    some (not all) calculations of spin wave spectra. Use 0.4.2 and later instead.
...
* Output of "K-POINTS.html", "SPIN_VECTORS.txt", "HIGH-SYMMETRY_POINTS.txt",
  "K-POINTS.txt" and  "SPIN_DIRECTIONS.html" of the ``magnopy-lswt`` script.
* Add ``magnopy.experimental`` submodule, where experimental features of Magnopy will be
  located. Those features might migrate to the core package in the future versions or be
  removed from it.
