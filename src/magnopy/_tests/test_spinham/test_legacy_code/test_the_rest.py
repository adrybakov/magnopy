...
def test_convention_manipulation():
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == 1
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 1
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == 2
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 1
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == 9 / 4
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 9 / 4
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == -0.5
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 1

    spinham.convention = Convention(True, False, c21=1, c22=-2)
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == -0.25
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 1
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == -0.5
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == 2
    ...
    assert converter22.to_iso(parameter=list(spinham.p22)[0][2]) == -9 / 8
    assert converter22.to_iso(parameter=spinham.p21[0][2]) == -9 / 4
...
def test_multiple_counting():
    ...
    assert (params[2][2] == params[3][2]).all()
    assert (params[5][2] == params[0][2]).all()
    assert (params[1][2] == params[4][2]).all()
